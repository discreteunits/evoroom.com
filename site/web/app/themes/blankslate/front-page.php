...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/app/themes/blankslate/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="/app/themes/blankslate/css/demo.css" />
		<link rel="stylesheet" type="text/css" href="/app/themes/blankslate/css/component.css" />
		<!--[if IE]>
	...
	<body class="demo-2">
		...
		<main>
			...
			<!-- Initial markup -->
			<div class="segmenter" style="background-image: url(/app/themes/blankslate/img/2.jpg)"></div>
		...
		<script src="/app/themes/blankslate/js/anime.min.js"></script>
		<script src="/app/themes/blankslate/js/imagesloaded.pkgd.min.js"></script>
		<script src="/app/themes/blankslate/js/main.js"></script>
		<script>
		(function() {
			var headline = document.querySelector('.trigger-headline'),
				...
				segmenter = new Segmenter(document.querySelector('.segmenter'), {
					...
					positions: [
						...
						{top: 5, left: 55, width: 5, height: 45}
					],
					onReady: function() {
